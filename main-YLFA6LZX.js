...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Yi,depthTest:!1,depthWrite:!1})}function tF(n,e,t){let i=new Float32Array(io),r=new N(0,1,0);return new jn({name:"SphericalGaussianBlur",defines:{n:io,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Yh(),fragmentShader:`
